...
<section class="w-full h-2/3 flex flex-row justify-center items-center bg-white-red font-poppins text-off-black mt-[72px]">
	<div class="ml-28 flex flex-col">
        ...
        <div>
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="text-[24px] font-bold text-off-black hover:text-red-500">Watch the video</a>
        </div>
	</div>

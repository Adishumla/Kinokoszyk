  ...
  <section id="about">
    <div class=" w-full vh-section bg-off-white flex flex-row justify-center items-center gap-[165px]">
      <div id="aboutPicture" class="h-[643.21px] w-[450px] shadowHome">
        <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/umbrellaMan.webp" alt="about image of a man with an umbrella staring over the ocean" class="object-fill h-full w-full min-w-[450px]">
      </div>
  ...
  <section id="event">
    <div class=" w-full vh-section bg-white-red flex flex-row items-center justify-center gap-[165px]">
      <div id="eventPicture" class="h-[643.21px] w-[450px] shadowHome min-w-[450px]">
        <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/womanWorkingBig.webp" alt="Event image of a woman working" class="object-fill h-full w-full min-w-[450px]">
      </div>

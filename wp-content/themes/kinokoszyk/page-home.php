...
<body>
  ...
  <section id="hero">
    ...
    <div>
      ...
      <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/heroCompressed.jpg" alt="hero image" class="object-cover w-full vh-hero">
  ...
  <section id="about">
    <div class=" w-full vh-section bg-off-white flex flex-row justify-center items-center gap-[165px]">
      <div id="aboutPicture" class="h-[643.21px] w-[450px] shadowHome">
        <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/umbrellaMan.jpg" alt="about image" class="object-fill h-full w-full min-w-[450px]">
      </div>
    ...
    <div class="w-full vh-section bg-white-red flex flex-row justify-center items-center gap-[165px]">
      ...
      <div id="pictureGrid" class=" grid grid-cols-2 grid-rows-2 h-[744.67px] w-[530px] gap-[30px] min-w-[530px]">
        <div class=" h-[357.3px] w-[250px] shadowHome">
          <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/ladiesGroupSmall.jpg" alt="ladies sitting together on the ground" class="object-cover h-full w-full">
        </div>
        <div class="h-[357.3px] w-[250px] shadowHome ">
          <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/ladyWorkingSmall.jpg" alt="lady working" class="object-fill h-full w-full">
        </div>
        <div class="h-[357.3px] w-[250px] shadowHome ">
          <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/ladySmokingSmall.jpg" alt="picure of lady smoking" class="object-cover h-full w-full">
        </div>
        <div class="h-[357.3px] w-[250px] shadowHome">
          <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/powerSmall.jpg" alt="picture of the womensday in ruda 1976" class="object-fill h-full w-full">
        </div>
      </div>
  </section>
  ...
  <section id="film">
    <div class=" w-full vh-section  flex justify-center items-center flex-col ">
      <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/filmCompressed.jpg" alt="" class="object-cover w-full vh-section">
  ...
  <section id="event">
    <div class=" w-full vh-section bg-white-red flex flex-row items-center justify-center gap-[165px]">
      <div id="eventPicture" class="h-[643.21px] w-[450px] shadowHome min-w-[450px]">
        <img src="<?= get_template_directory_uri() ?>/assets/compressedPictures/ladyWorkingBig.jpg" alt="event image" class="object-fill h-full w-full min-w-[450px]">
      </div>

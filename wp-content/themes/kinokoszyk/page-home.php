...
<section id="hero">
  <div>
    ...
    <div id="heroTitle" class=" bottom-0 absolute">
      <h1 class="poppins sm:text-[100px] sm:leading-[76px] lg:text-[200px] lg:leading-[152px] text-white">KINO KOSZYK</h1>
    </div>
  </div>
...
<section id="about" class="px-8 bg-off-white ">
  <div class=" w-full vh-section flex flex-row justify-evenly items-center gap-[5%]">
    <div id="aboutPicture" class=" shadowHome sm:max-w-[243px] sm:max-h-[341px] h-7/12 w-5/12 lg:max-w-[450px] lg:max-h-[643.21px]">
    ...
    <div id=aboutTextbox class="textboxHome sm:w-[319px] lg:w-[673px]">
      <h2 class="font-prata sm:text-[52px] sm:leading-[40px] lg:text-[80px] lg:leading-[58px] mb-[26px]">Kino Koszyk</h2>
      <p class="poppins sm:text-[18px] sm:leading-[26px] lg:text-[20px] lg:leading-[28px]">With a passion for storytelling and a commitment to authenticity, Kino Koszyk produces thought-provoking documentaries that provide insight into the complex and fascinating history, culture, and people of Poland. Through their work, they aim to promote greater understanding and appreciation of this beautiful country and its people.</p>
...
<section id="joanna" class="px-8 bg-white-red">
  <div class="w-full vh-section  flex flex-row justify-evenly items-center gap-[5%]">
    <div id=joannaTextbox class=" textboxHome sm:w-[319px] lg:w-[673px]">
      <h3 class="poppins sm:text-[24px] lg:text-[26px] text-wine">Photographer</h3>
      <h2 class="font-prata sm:text-[52px] sm:leading-[40px] lg:text-[80px] lg:leading-[86px] mb-[26px]">Joanna Helander</h2>
      <p class="poppins sm:text-[18px] sm:leading-[26px] lg:text-[20px] lg:leading-[28px]">Discover the beauty captured through the lens of our talented artist Joanna. Explore her stunning photography and allow yourself to be transported to new worlds of wonder and awe.</p>
    ...
    <div id="pictureGrid" class=" grid grid-cols-2 grid-rows-2 sm:max-w-[243px] sm:max-h-[341px] sm:gap-[13.74px] lg:max-h-[744.67px] lg:max-w-[530px] lg:gap-[30px] w-6/12 h-8/12 ">
...
<section id="film">
  <div class=" w-full vh-section  flex justify-center items-center flex-col ">
    ...
    <div id=filmTextbox class="lg:w-[673px] sm:w-[319px] lg:h-[268px] absolute right-0 lg:mr-[180px] sm:mr-[88px] gap-[32px] text-off-white">
      <h2 class="font-prata sm:text-[52px] sm:leading-[40px] lg:text-[80px] lg:leading-[58px] mb-[26px] ">Film</h2>
      <p class="poppins sm:text-[18px] sm:leading-[26px] lg:text-[20px] lg:leading-[28px]">Experience the magic of cinema with Kino Kozsyks. Our films take you on a journey beyond the screen, with captivating stories and stunning visuals that will leave you inspired. Don't miss out on the opportunity to immerse yourself in the world of Kino Kozsyks. </p>
...
<section id="event" class="px-8 bg-white-red">
  <div class=" w-full vh-section flex flex-row items-center justify-evenly gap-[5%]">
    <div id="eventPicture" class="shadowHome sm:max-w-[243px] sm:max-h-[341px] h-7/12 w-5/12 lg:max-w-[450px] lg:max-h-[643.21px]">
    ...
    <div id=eventTextbox class="textboxHome sm:w-[319px] lg:w-[673px]">
      <h2 class="font-prata sm:text-[52px] sm:leading-[40px] lg:text-[80px] lg:leading-[58px] mb-[26px] ">Event</h2>
      <p class="poppins sm:text-[18px] sm:leading-[26px] lg:text-[20px] lg:leading-[28px]">Discover the latest movie screenings and events at Kino Koszyk's event page! Immerse yourself in a world of cinema and entertainment with our diverse range of films, from classics to new releases. Join us for a unique cinematic experience in the heart of the city. Book your tickets now and be a part of the excitement!</p>

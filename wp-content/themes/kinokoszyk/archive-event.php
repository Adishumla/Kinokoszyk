...
<section class="h-2/3 flex flex-row justify-center items-center bg-white-red poppins text-off-black mt-[72px] mb-[72px] ml-[72px]">
    <div class="ml-28">
        ...
        <div class="w-3/6 max-w-[800px] mt-4 w-full">
    ...
    <img class="object-fill justify-self-end w-auto max-w-[580px] mr-0 pr-0 ml-36" src="<?= get_template_directory_uri(); ?>/assets/events.svg" alt="" style="width: auto !important;">
</section>

<section class="bg-off-white flex flex-row-reverse justify-between items-center py-12 px-44 w-full">
    <div>
...
echo '<div class="flex justify-center align-center pt-10">';
